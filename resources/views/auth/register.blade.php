                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('familyName') ? ' has-error' : '' }}">
                            <label for="familyName" class="col-md-4 control-label">Votre nom</label>
                            <div class="col-md-6">
                                <input id="familyName" type="text" class="form-control" name="familyName" value="{{ old('familyName') }}" required >
